...
admin_header('Drivers', 'drivers', 'Approve driver accounts, manage licenses, and maintain vehicle profile details.');
?>

<div class="card border-0 shadow-sm">
    <div class="card-header bg-white d-flex flex-wrap align-items-center justify-content-between gap-2">
        <div>
            <h2 class="h6 mb-0">Driver Directory</h2>
        ...
        <div class="table-responsive">
            <table class="table align-middle mb-0">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="driver-documents">
                                    ...
                                    <?= render_document_link($rider['vehicle_photo_path'] ?? null, 'Vehicle') ?>
                                    <?= render_document_link($rider['registration_path'] ?? null, 'ORCR') ?>
                                </div>
                            </td>
                            ...
                            <td class="text-end">
                                ...
                                <form class="d-inline" method="post" data-confirm="Delete this driver and assigned vehicle records?">
                                    <?= csrf_field() ?>
                    ...
                    <?php endforeach; ?>
                    <?php if (!$riders): ?>
                        <tr><td colspan="9" class="text-center text-secondary py-4">No drivers yet.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
    ...
    <div class="modal fade" id="viewRider<?= (int) $rider['id'] ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header"><h3 class="modal-title h5">Driver Verification Details</h3><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
                <div class="modal-body">
                    <div class="detail-grid mb-4">
                        <div class="detail-card"><h4>Driver</h4><p><?= e(full_name($rider)) ?></p></div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <?php if (asset_url($rider['vehicle_photo_path'] ?? null)): ?>
                        ...
                        <div class="col-12">
                            ...
                            <?= render_document_link($rider['registration_path'] ?? null, 'Open ORCR document') ?>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="createRiderModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <form class="modal-content" method="post">
            ...
            <div class="modal-header"><h3 class="modal-title h5">Add Driver</h3><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
            <div class="modal-body"><?php include __DIR__ . '/partials/rider_fields.php'; ?></div>
            <div class="modal-footer"><button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button><button class="btn btn-primary" type="submit">Save driver</button></div>
        </form>
    </div>
</div>
    ...
    <div class="modal fade" id="editRider<?= (int) $record['id'] ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <form class="modal-content" method="post">
                ...
                <div class="modal-header"><h3 class="modal-title h5">Edit Driver</h3><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
                <div class="modal-body"><?php include __DIR__ . '/partials/rider_fields.php'; ?></div>
                <div class="modal-footer"><button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button><button class="btn btn-primary" type="submit">Update driver</button></div>
            </form>
        </div>
    </div>
<?php endforeach; ?>
