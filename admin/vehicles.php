                ...
                <tbody>
                    <?php foreach ($vehicles as $vehicle): ?>
                        <tr>
                            ...
                            <td>
                                <?php if (asset_url($vehicle['vehicle_photo_path'] ?? null)): ?>
                            ...
                            <td><?= render_document_link($vehicle['registration_path'] ?? null, 'Open ORCR') ?></td>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3"><?= render_document_link($vehicle['registration_path'] ?? null, 'Open ORCR document') ?></div>
